...
export const Footer = () => {
  return (
    <footer className="bg-black w-full bottom-0 mt-auto" id="footer-content-wrapper">
        ...
        <div className='mt-[32px] mb-0 flex mx-[24px] md:mx-20' id='copyright-and-details'>
            <span className='text-white-800 pb-4 text-[12px]'>2024 &copy; Beatrice Hahn</span>
            <span className='text-white-800 pl-8 pb-4 text-[12px]'>Product Designer & Developer</span>
        </div>
    </footer>
  )
}
